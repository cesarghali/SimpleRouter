                         ...
                         char* server)
{
    ...
    if(port != 12345) /* DGU TMP: no auth for old style clients for now */
    ...
    if(((uint32_t)(send(sr->sockfd, buf, buf_len, 0))) != buf_len)
    {
